 ...
 */
 ...
 class FreeNews_category_slide extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget_category_slide', 'description' => esc_html__( 'Display  Slider in home page', 'freenews') );
		$control_ops = array('width' => 200, 'height' => 250);
		parent::__construct( false, $name=esc_html__('T-Spiral: Category Slide','freenews'), $widget_ops, $control_ops );
	}
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'no_of_slides' )); ?>"><?php esc_html_e( 'Number of Slider:', 'freenews' ); ?></label> 
		...
		<p><input type="radio" <?php checked(esc_attr($multiple_slide), 'multiple_slide'); ?> id="<?php echo $this->get_field_id( 'multiple_slide' ); ?>" name="<?php echo esc_attr($this->get_field_name( 'multiple_slide' )); ?>" value="multiple_slide"/><?php esc_html_e( 'Multiple Slide', 'freenews' );?>
			<br>
		 <input type="radio" <?php checked(esc_attr($multiple_slide), 'single'); ?> id="<?php echo esc_attr($this->get_field_id( 'multiple_slide' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'multiple_slide' )); ?>" value="single"/><?php esc_html_e( 'Single Slide', 'freenews' );?>
		</p>
		...
		<p>
			...
			<?php wp_dropdown_categories( array( 'show_option_none' =>esc_html__('-- Select -- ','freenews'),'name' => esc_attr($this->get_field_name( 'category' )), 'selected' => esc_attr($category) ) ); ?>
		</p>
