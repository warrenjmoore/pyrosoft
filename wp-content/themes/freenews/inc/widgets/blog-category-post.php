 ...
 */
 ...
 class FreeNews_blog_category_posts extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget_blog_category_posts', 'description' => esc_html__( 'Display single blog column in home page', 'freenews') );
		$control_ops = array('width' => 200, 'height' => 250);
		parent::__construct( false, $name=esc_html__('T-Spiral: Blog Category Posts','freenews'), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="blog-category-post-wrap">
			...
			<div class="blog-category-post">
				...
				<div class="blog-category-post-content">
					...
					<h2 class="blog-category-post-title"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
					<div class="blog-category-post-meta">
						<?php
		...
		<?php echo $after_widget . '<!-- .widget_blog_category_posts -->';
	}
